...
class LocationInitialConNode:CCTNode,ASEditableTextNodeDelegate {
    
    var initialConsumptionTextNode:ASEditableTextNode!
    var initialConsumptionTitleNode:CTTTextNode!
    ...
    override init() {
        ...
        initialConsumptionTitleNode = CTTTextNode(withFontSize: 15, color: .black, with: "Consumo Inicial")
    }
    
    
    override func layoutSpecThatFits(_ constrainedSize: ASSizeRange) -> ASLayoutSpec {
        let contentStack = ASStackLayoutSpec.horizontal()
        contentStack.children = [initialConsumptionTitleNode,initialConsumptionTextNode]
